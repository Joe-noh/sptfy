defmodule Sptfy.PersonalizationTest do
  ...
  describe "get_top_artists/2" do
    test "returns a Paging structs" do
      ...
      with_mock Sptfy.Client.HTTP, get: fn _, "/v1/me/top/artists", _ -> MockHelpers.response(json) end do
  ...
  describe "get_top_tracks/2" do
    test "returns a Paging struct" do
      ...
      with_mock Sptfy.Client.HTTP, get: fn _, "/v1/me/top/tracks", _ -> MockHelpers.response(json) end do

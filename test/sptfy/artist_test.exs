defmodule Sptfy.ArtistTest do
  ...
  describe "get_artists/2" do
    test "returns list of FullArtist structs" do
      ...
      with_mock Sptfy.Client.HTTP, get: fn _, "/v1/artists", _ -> MockHelpers.response(json) end do
  ...
  describe "get_artist/2" do
    test "returns a FullArtist struct" do
      with_mock Sptfy.Client.HTTP, get: fn _, "/v1/artists/abc", _ -> MockHelpers.response(Fixtures.full_artist()) end do
    ...
    test "returns Error struct on error" do
      ...
      with_mock Sptfy.Client.HTTP, get: fn _, "/v1/artists/abc", _ -> MockHelpers.response(json) end do
  ...
  describe "get_top_tracks/2" do
    test "returns a list of FullTrack structs" do
      ...
      with_mock Sptfy.Client.HTTP, get: fn _, "/v1/artists/abc/top-tracks", _ -> MockHelpers.response(json) end do
  ...
  describe "get_related_artists/2" do
    test "returns a list of FullArtist structs" do
      ...
      with_mock Sptfy.Client.HTTP, get: fn _, "/v1/artists/abc/related-artists", _ -> MockHelpers.response(json) end do
  ...
  describe "get_albums/2" do
    test "returns a Paging structs" do
      ...
      with_mock Sptfy.Client.HTTP, get: fn _, "/v1/artists/abc/albums", _ -> MockHelpers.response(json) end do

defmodule Sptfy.TrackTest do
  ...
  describe "get_track/2" do
    test "returns a Track struct" do
      with_mock Sptfy.Client.HTTP, get: fn _, "/v1/tracks/abc", _ -> TestHelpers.response(Fixtures.full_track()) end do
  ...
  describe "get_tracks_audio_features/2" do
    test "returns list of AudioFeature structs" do
      ...
      with_mock Sptfy.Client.HTTP, get: fn _, "/v1/audio-features", _ -> TestHelpers.response(json) end do
  ...
  describe "get_track_audio_features/2" do
    test "returns list of AudioFeature structs" do
      with_mock Sptfy.Client.HTTP, get: fn _, "/v1/audio-features/abc", _ -> TestHelpers.response(Fixtures.audio_feature()) end do

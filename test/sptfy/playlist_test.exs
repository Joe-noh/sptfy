defmodule Sptfy.PlaylistTest do
  ...
  describe "create_user_playlist/2" do
    test "returns a Playlist struct" do
      with_mock Sptfy.Client.HTTP, post: fn _, "/v1/users/abc/playlists", _, _ -> TestHelpers.response(Fixtures.full_playlist()) end do
  ...
  describe "get_playlist/2" do
    test "returns a FullPlaylist struct" do
      with_mock Sptfy.Client.HTTP, get: fn _, "/v1/playlists/abc", _ -> TestHelpers.response(Fixtures.full_playlist()) end do

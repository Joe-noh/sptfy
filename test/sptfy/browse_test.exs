defmodule Sptfy.BrowseTest do
  ...
  describe "get_category/2" do
    test "returns a Category struct" do
      with_mock Sptfy.Client.HTTP, get: fn _, "/v1/browse/categories/abc", _ -> TestHelpers.response(Fixtures.category()) end do
  ...
  describe "get_recommendations/2" do
    test "returns a Recommendation struct" do
      with_mock Sptfy.Client.HTTP, get: fn _, "/v1/recommendations", _ -> TestHelpers.response(Fixtures.recommendation()) end do
